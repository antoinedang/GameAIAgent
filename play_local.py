...
white_player = GameClient(color=Color.white, gameID=93)
black_player = GameClient(color=Color.black, gameID=93)

white_thread = threading.Thread(target=white_player.start)
black_thread = threading.Thread(target=black_player.start)
